...
/**
 * Signal/Wifi-like icon for credit cards.
 */
export const SignalIcon = ({ size = 24, ...props }: IconProps) => (
    <svg
...
/**
 * Payment/Banknote icon.
 */
export const PaymentIcon = ({ size = 24, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
 ...
 */
export const StatementIcon = ({ size = 24, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
 ...
 */
export const CurrencyIcon = ({ size = 20, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
